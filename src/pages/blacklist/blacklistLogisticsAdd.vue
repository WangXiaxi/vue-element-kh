  ...
  <div class="blacklist-factory">
    ...
    <div class="content clear">
      <div class="content-left">
        <left-menu-router-account activeLink="black"></left-menu-router-account>
      </div>
      <div class="content-right" v-loading="loading">
        <div class="main fr">
          <p class="title-box"><span class="title-name">黑名单管理 < 添加黑名单</span></p>
          <div class="container">
            <div class="top-sort">
              <ul>
                <li>司机身份：</li>
                <li :class="[(searchList.Crowd == 1) ? 'active' : '']" @click="searchList.Crowd = 1">工厂企业</li>
            ...
            <div class="top-sort">
              <ul>
                ...
                <li class="input-width-300"><el-input size="mini" placeholder="请输入工厂企业，个体司机司机名称，支持模糊查询" v-model="searchList.Name"></el-input></li>
                <li><el-button type="primary" size="mini" @click="getDataPage">查询</el-button></li>
            ...
            <div class="top-sort">
              <ul>
                ...
                <li><el-button type="primary" class="input-width-120" size="mini" @click="sureAddBlack">加入黑名单</el-button></li>
              </ul>
            </div>
            <el-table
              center
...
import { getSearchBlackList, addBlackList } from "api/getData"
...
export default {
  ...
  methods: {
    ...
    async getDataPage () { // 获取数据内容操作
      this.loading = true
      const resData = await getSearchBlackList(this.searchList)
      if (resData.data.ResultCode == "000000") {
